...
#ifndef LIBMLUTIL_DLIST_H
# define LIBMLUTIL_DLIST_H
...
#define LIST_FIRST(LIST, NEXT, PREV)	(LIST)

#define LIST_LAST(LIST, NEXT, PREV)					\
  ((LIST)==NULL ? NULL : LIST_PREV_WRAP(LIST, LIST, NEXT, PREV))

#define LIST_NEXT(LIST, REG, NEXT, PREV)	((REG)->NEXT)
...
#define LIST_PREV_WRAP(LIST, REG, NEXT, PREV) ((REG) ? (REG)->PREV : (LIST))
